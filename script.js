...
function btnchange2() {
    if (btntrue2 == true) {
        btntrue2 = false;
        like2.src = "./images/heart2.png";
    }
    else if (btntrue2 == false) {
        btntrue2 = true;
        like2.src = "heart3.png";
    }
}
...
function btnchange3() {
    if (btntrue3 == true) {
        btntrue3 = false;
        like3.src = "./images/heart2.png";
    }
    else if (btntrue3 == false) {
        btntrue3 = true;
        like3.src = "heart3.png";
    }
}